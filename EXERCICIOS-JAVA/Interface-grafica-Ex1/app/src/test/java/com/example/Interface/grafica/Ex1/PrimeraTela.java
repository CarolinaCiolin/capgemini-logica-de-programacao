 ...
 * @author komat
 */
public class PrimeraTela extends javax.swing.JFrame {

    /**
     * Creates new form PrimeraTela
     */
    public PrimeraTela() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrimeraTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrimeraTela().setVisible(true);
            }
        });
    }
